...
log_decision_gate_summary = log_gate_summary
...
def record_langfuse_gate_scores(
    *,
    ...
    """Legacy signature accepting ``add_score_fn`` + ``trace_id``."""
    record_gate_scores(
        telemetry=TelemetryContext.with_callback(trace_id, add_score_fn),
        raw_count=raw_count,
        alerts=alerts,
