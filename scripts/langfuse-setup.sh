...
echo "╚══════════════════════════════════════════════════╝"
echo ""
echo "  Decision prompts can be edited in the Langfuse UI."
echo "  Create two prompts under Prompts → New:"
echo ""
echo "    Name: decision-system"
echo "    Name: decision-user"
echo ""
echo "  Use {{variable}} placeholders (e.g. {{symbol}},"
echo "  {{ta_summary}}, {{flow_summary}}, etc.)."
echo "  Publish with label 'production' to go live."
echo "  If no Langfuse prompts exist, built-in fallbacks are used."
echo ""
